use super::super::components::{
    EquipmentContainer, MenuCDRText, MenuCritText, MenuDamageText, MenuGoldText, MenuHealthText,
    MenuLifestealText, ShopButton, ShopBuyButton, ShopBuyButtonPrice, ShopBuyButtonText,
    ShopContainer, TabButton, TutorialButton, WeaponMenuRestartButton, WeaponMenuSettingsButton,
    WeaponMenuTab, WeaponMenuUI,
};
    ...
    commands
        ...
        .with_children(|root| {
            ...
            .with_children(|sidebar| {
                ...
                .observe(crate::systems::ui::interaction::handle_tab_interaction)
                .with_children(|btn| {
                    btn.spawn((
                        Text::new("UPGRADES"),
                        TextFont {
